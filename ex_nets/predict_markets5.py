...
deep1 = mm.make_deepnet(layers,backward*data.shape[-1],128,5)
...
def makeme():
    ...
    l_1 = Flatten()(input_l)
    l_2 = deep1(l_1)
    l_3 = Dense(1*data.shape[-1],activation='linear')(l_2)
...
if __name__ == '__main__':
    ...
    model.save_weights('callbacks/CosHot_weights/{0}'.format(filename))
