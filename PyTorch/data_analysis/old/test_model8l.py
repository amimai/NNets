    ...
    def train(self,batch_size,EPOCHS=1,test_loader=None,transform = False):
        ...
        for epoch in range(1, EPOCHS + 1):
            ...
            for x, label in train_loader:
                ...
                t,f=torch.ones(*label.shape)*1.,torch.ones(*label.shape)*-1.
                ...
                # add abd squared dis loss
                loss = torch.add(criterion(out**2, label.to(device).float()**2)/2,loss)
