...
class GRUNet(nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim, batch_size, n_layers, backwards, drop_prob=0.10, GPUs=1):
        ...
        self.mha1 = torch.nn.MultiheadAttention(hidden_dim, int(hidden_dim/4))
        self.mha2 = torch.nn.MultiheadAttention(hidden_dim, int(hidden_dim/4))
        self.mha3 = torch.nn.MultiheadAttention(hidden_dim, int(hidden_dim/4))
